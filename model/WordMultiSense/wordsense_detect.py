...
class MultiSenDetect(object):
    def __init__(self):
        ...
        self.embedding_path = "G:\luojie\sgns.wiki.word"
    ...
    def concept_cluster(self, sens_dict):
        ...
        for sen1 in sens_dict:
            ...
            for sen2 in sens_dict:
                ...
                # 设定阈值，保留相似度高的，目的是对同义的词进行聚类为一个列表中
    ...
    def detect_main(self, sent, word):
        ...
        # print("关键词的多个义项:", concept_dict)
        # 基于wordvector，通过lookup table的方式找到句子的wordvector的表示
        sent_vector = self.rep_sentencevector(sent)
        # print("句子wordvect表示：",sent_vector)
        ...
        # print(222,concept_scores_sent)
        # print(333,concept_scores_wds)
...
def run():
    ...
    while(1):
        ...
        print("sent_embedding_res:",sent_embedding_res)
        print("wds_embedding_res:",wds_embedding_res)
